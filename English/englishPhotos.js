...
const PrevArrow = ({ className, style, onClick }) => (
  <button style={{ ...style, left: 0, backgroundColor: 'black' }} onClick={onClick} className={className}>
    <div>back</div>
  </button>
);

const NextArrow = ({ className, style, onClick }) => (
  <button style={{ ...style, right: 0, backgroundColor: 'black' }} onClick={onClick} className={className}>
    <div>back</div>
  </button>
);
